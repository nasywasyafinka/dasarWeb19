...
<body>
    <div class="container mt-4">
        <h2>Data Anggota</h2>
        <a class="btn btn-success mt-2" href="createB.php">Tambah Data</a>
        <br><br>
        <?php
        include('koneksi.php');
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="editB.php?id=<?= $row["id"] ?>">Edit</a>
                        ...
                        <div class='modal-dialog' role='document'>
                            <div class='modal-content'>
                                ...
                                <div class='modal-footer'>
                                    <a class="btn btn-danger" href="prosesB.php?aksi=hapus&id=<?= $row["id"] ?>">Hapus</a>
